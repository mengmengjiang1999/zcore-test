...
fn main() {
    ...
    // let zcore_dir = format!("{}/zCore", cwd);

    // make clean; remove any leftover gunk from prior builds
    // Command::new("make")
    //     .arg("clean")
    //     .current_dir(zcore_dir.clone())
    //     .status()
    //     .expect("Couldn't clean zcore directory");
    ...
    //     .env("CC", "/home/mmj/Project/AFLplusplus/afl-clang-fast")
    //     .env("CXX", "/home/mmj/Project/AFLplusplus/afl-clang-fast++")
    //     .current_dir(xpdf_dir.clone())
    //     .status()
